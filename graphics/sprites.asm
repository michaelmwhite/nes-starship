    .db $80, $04, $00, $80      ; each sprite is represented by 4 bytes - 1 byte each for their y position in pixels, the tile id in the 
                                ...
                                ; values specified in this file are now default values as they are later modified via variables